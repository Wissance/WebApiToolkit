...
namespace Wissance.WebApiToolkit.Managers
{
    ...
    public abstract class EfModelManager<TObj, TRes, TId, TQueryParameters> : IModelManager<TRes, TObj, TId, TQueryParameters>
        ...
        where TQueryParameters : class, new()
    {
        ...
        public EfModelManager(DbContext dbContext, Func<TObj, TQueryParameters, bool> filterFunc, Func<TObj, TRes> createFunc,
